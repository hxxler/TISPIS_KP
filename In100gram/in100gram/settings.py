...
SECRET_KEY = os.environ.get('SECRET_KEY', default="django-insecure-2)awi45-c4!$1)f@$04+smaxw#u@2g#pe#)7(%sm^wux=ijixy")
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'in100gram'),
        'USER': os.environ.get('DB_USER', 'in100gram_user'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'password'),
        'HOST': os.environ.get('DB_HOST', 'postgre'),
        'PORT': '5432',
    }
}
